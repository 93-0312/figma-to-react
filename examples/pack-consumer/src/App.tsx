...
import { Button, Meter, InputOTP, InputOTPSlot, InputOTPSeparator, Field, Input } from "@eromnet/bo-ui-kit";
...
export default function App() {
  return (
    <div style={{ padding: 24, display: "grid", gap: 20, maxWidth: 380, fontFamily: "Pretendard, system-ui, sans-serif" }}>
      <h1 style={{ fontSize: 18, fontWeight: 600 }}>@eromnet/bo-ui-kit · pack(tarball) consumer</h1>
