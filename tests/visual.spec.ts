 ...
 */
const STORIES = ["Button", "Checkbox", "Input", "Label", "Field", "Input OTP", "Meter", "Toggle", "Toggle Group", "Select", "Switch", "Separator", "Skeleton", "Spinner", "Textarea", "Avatar", "Avatar Group", "Badge"] as const;
