 ...
 *
 * NOTE(2026-07-13 sync 보류, 2026-07-14 재확인에도 동일 상태): Figma의 `Color=neutral` Fill/Tinted 가
 * 모두 동일한 새 값(#eff2f7, VariableID:5632:2342=accent 로 재바인딩)으로 수렴했고 Text 는 어둡게(#212226)
