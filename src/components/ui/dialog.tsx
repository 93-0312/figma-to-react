 ...
 * 패널 bg-popover+border(#e1e6ec, 2026-07 Figma 갱신 — 기존 #0f172b@8%에서 불투명 색으로 분리)+rounded-2xl. 그림자 없음(Figma Dialog effects 비어있음; AlertDialog 만 popover 그림자). 백드롭 black@32%+blur. ESC/바깥클릭/X 로 닫기, 스크롤 잠금.
